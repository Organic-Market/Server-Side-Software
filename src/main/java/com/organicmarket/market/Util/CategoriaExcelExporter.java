...
public class CategoriaExcelExporter {
    ...
    private List<CategoriaProducto> category;


    public CategoriaExcelExporter (List<CategoriaProducto> categories) {
        this.category = categories;
        workbook = new XSSFWorkbook();
    }

    private void writeHeaderLine() {
        sheet = workbook.createSheet("Categoria");
    ...
    private void writeDataLines() {
        ...
        for( CategoriaProducto result: category) {
